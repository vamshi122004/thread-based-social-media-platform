    ...
    const mockPosts: Post[] = [
      {
        id: "1",
        content:
          "Hi everyone! I'm a frontend developer passionate about React...",
        author: "dev_sarah",
    ...
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8">
        ...
        <p className="text-muted-foreground">
          Manage users, threads, and content across the platform
        </p>
      </div>
                ...
                {threads.map((thread) => (
                  ...
                  >
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-muted-foreground">
                        By: {thread.author} | Topic: {thread.topic} | Replies:{" "}
                        {thread.replies}
                      </p>
                      <p className="text-xs text-muted-foreground">
        ...
        <TabsContent value="posts" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Moderate user posts and replies</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
                {posts.map((post) => (
                  ...
                  >
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-muted-foreground">
                        By: {post.author} | Thread: {post.threadTitle}
                      </p>
                      <p className="text-xs text-muted-foreground">
