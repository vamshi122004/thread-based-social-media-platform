...
const ThreadDetail = () => {
  ...
  useEffect(() => {
    ...
    const mockThread: Thread = {
      ...
      content: 'This is a community space where we can all connect and share ideas. Feel free to introduce yourself and tell us what brings you here! We\'re excited to have you as part of our growing community.',
      author: 'admin',
      topic: 'general',
    ...
    const mockPosts: Post[] = [
      {
        id: '1',
        content: 'Hi everyone! I\'m a frontend developer passionate about React and modern web technologies. Looking forward to sharing knowledge and learning from this community!',
        author: 'dev_sarah',
      ...
      {
        id: '2',
        content: 'Welcome! This looks like a great platform for developers to connect. I\'m particularly interested in discussing best practices and emerging trends.',
      ...
      {
        id: '3',
        content: 'Excited to be here! I\'m a UI/UX designer and always love collaborating with developers. This seems like the perfect place for that.',
        author: 'design_guru',
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      ...
      <Card className="mb-6 shadow-card">
        ...
        <CardContent>
          <p className="text-foreground mb-4 leading-relaxed">{thread.content}</p>
          ...
          <div className="flex items-center justify-between">
            ...
            <Button
              ...
              className={`flex items-center gap-1 ${thread.isLiked ? 'text-red-500' : ''}`}
            >
      ...
      {user ? (
        <Card className="shadow-card">
          <CardHeader>
            ...
            <CardDescription>Share your thoughts on this thread</CardDescription>
          </CardHeader>
          <CardContent>
